...
import (
	...
	kubedgev1alpha1 "github.com/example-inc/useless-operator/pkg/apis/kubedge/v1alpha1"
...
// Add creates a new Useless Controller and adds it to the Manager. The Manager will set fields on the Controller
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &kubedgev1alpha1.Useless{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &kubedgev1alpha1.Useless{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileUseless) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &kubedgev1alpha1.Useless{}
	...
	// Set Useless instance as the owner and controller
...
func newPodForCR(cr *kubedgev1alpha1.Useless) *corev1.Pod {
